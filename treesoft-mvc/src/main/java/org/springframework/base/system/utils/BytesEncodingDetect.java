...
/* loaded from: spring-tx-4.1.3.RELEASE.jar:org/springframework/base/system/utils/BytesEncodingDetect.class */
                    ...
                    while (rawtext[i] != 27) {
                        ...
                        if (33 <= rawtext[i] && rawtext[i] <= 126 && 33 <= rawtext[i + 1] && rawtext[i + 1] <= 126) {
                            ...
                            if (this.EUC_TWFreq[row2][column2] != 0) {
                                c += this.EUC_TWFreq[row2][column2];
