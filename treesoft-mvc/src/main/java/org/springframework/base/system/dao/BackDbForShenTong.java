...
/* loaded from: spring-tx-4.1.3.RELEASE.jar:org/springframework/base/system/dao/BackDbForShenTong.class */
public class BackDbForShenTong {
    ...
    public void readDataToFile(String databaseName, String tableName, String path, String databaseConfigId) throws Exception {
        ...
        try {
            try {
                ...
                sb.append("/* \r\n");
                sb.append("TreeSoft Data Transfer For ShenTong \r\n");
                ...
                while (it.hasNext()) {
                    ...
                    for (int yy = 0; yy < rowCount; yy += 20000) {
                        String sql3 = "select  *  from  `" + databaseName + "`.`" + table_name + "`  LIMIT " + limitFrom + ",20000";
                        List<Map<String, Object>> list = db.queryForListForMySql(sql3);
                        limitFrom += 20000;
