...
@Repository
/* loaded from: spring-tx-4.1.3.RELEASE.jar:org/springframework/base/system/dao/CacheDao.class */
public class CacheDao {
    ...
    public List<Map<String, Object>> getAllTablesForCache(String dbName, String databaseConfigId) throws Exception {
        ...
        List<Map<String, Object>> list = db.queryForListCommonMethod(" select TABLE_NAME  from  INFORMATION_SCHEMA.TABLES  WHERE TABLE_SCHEMA ='SQLUser' AND TABLE_TYPE='BASE TABLE' order by  TABLE_NAME ");
        return list;
    }

    public List<Map<String, Object>> getTableColumns3ForCache(String dbName, String tableName, String databaseConfigId) throws Exception {
    ...
    public List<Map<String, Object>> getAllViewsForCache(String dbName, String databaseConfigId) throws Exception {
        DBUtilJDBC db = new DBUtilJDBC(dbName, databaseConfigId);
        List<Map<String, Object>> list = db.queryForListCommonMethod(" select  TABLE_NAME from  INFORMATION_SCHEMA.VIEWS  WHERE TABLE_SCHEMA='SQLUser' order by TABLE_NAME  ");
        return list;
    }
    ...
    public Page<Map<String, Object>> getDataForCache(Page<Map<String, Object>> page, String tableName, String dbName, String databaseConfigId) throws Exception {
        ...
        List<Map<String, Object>> list = db.queryForListForCache(sql2, limitFrom, pageSize);
        int rowCount = db.executeQueryForCount(sql);
        List<Map<String, Object>> columns = getTableColumnsForCache(dbName, tableName, databaseConfigId);
    ...
    public List<Map<String, Object>> getPrimaryKeyssForCache(String databaseName, String tableName, String databaseConfigId) throws Exception {
        String sql = " SELECT COLUMN_NAME  FROM INFORMATION_SCHEMA.COLUMNS  WHERE TABLE_SCHEMA='" + databaseName + "' AND TABLE_NAME = '" + tableName.toUpperCase() + "' AND PRIMARY_KEY ='YES' ";
        DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
        List<Map<String, Object>> list = db.queryForListCommonMethod(sql);
        return list;
    }

    public List<Map<String, Object>> getTableColumnsForCache(String dbName, String tableName, String databaseConfigId) throws Exception {
    ...
    public Page<Map<String, Object>> executeSqlHaveResForCache(Page<Map<String, Object>> page, String sql, String dbName, String databaseConfigId) throws Exception {
        int rowCount;
        int pageNo = page.getPageNo();
        int pageSize = page.getPageSize();
        int limitFrom = (pageNo - 1) * pageSize;
        DBUtilJDBC db = new DBUtilJDBC(dbName, databaseConfigId);
        Date b1 = new Date();
        List<Map<String, Object>> list = db.queryForListForCache(sql, limitFrom, pageSize);
        Date b2 = new Date();
        long executeTime = b2.getTime() - b1.getTime();
        if (list.size() < 10) {
            rowCount = list.size();
        } else {
            rowCount = db.executeQueryForCount(sql);
        }
        List<Map<String, Object>> columns = executeSqlForColumnsForCache(sql, dbName, databaseConfigId);
        List<Map<String, Object>> tempList = new ArrayList<>();
        Iterator<Map<String, Object>> it = columns.iterator();
        while (it.hasNext()) {
            Map<String, Object> map = it.next();
    ...
    public List<Map<String, Object>> executeSqlForColumnsForCache(String sql, String dbName, String databaseConfigId) throws Exception {
    ...
    public int updateTableNullAbleForCache(String databaseName, String tableName, String column_name, String is_nullable, String databaseConfigId) throws Exception {
        ...
        if (column_name != null && !column_name.equals("")) {
            DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
            String column_type = selectOneColumnTypeForCache(databaseName, tableName, column_name, databaseConfigId);
    ...
    public String selectOneColumnTypeForCache(String databaseName, String tableName, String column_name, String databaseConfigId) throws Exception {
    ...
    public int savePrimaryKeyForCache(String databaseName, String tableName, String column_name, String isSetting, String databaseConfigId) throws Exception {
        if (column_name != null && !column_name.equals("")) {
            DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
            List<Map<String, Object>> list2 = selectTablePrimaryKeyForCache(databaseName, tableName, databaseConfigId);
    ...
    public List<Map<String, Object>> selectTablePrimaryKeyForCache(String databaseName, String tableName, String databaseConfigId) throws Exception {
    ...
    public int saveDesginColumnForCache(Map<String, String> map, String databaseName, String tableName, String databaseConfigId) throws Exception {
        DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
    ...
    public int updateTableColumnForCache(Map<String, Object> map, String databaseName, String tableName, String columnName, String idValues, String databaseConfigId) throws Exception {
    ...
    public boolean dropTableForCache(String databaseName, String tableName, String databaseConfigId) throws Exception {
        ...
        db.setupdateData(sql);
        LogUtil.i(String.valueOf(DateUtils.getDateTime()) + ",删除Cache 表,SQL =" + sql);
        return true;
    }

    public int saveRowsForCache(Map<String, String> map, String databaseName, String tableName, String databaseConfigId, String username, String ip) throws Exception {
        DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
        ...
        while (it.hasNext()) {
            ...
            String columnType = selectColumnTypeForCache(databaseName, tableName, entry.getKey(), databaseConfigId);
    ...
    public int deleteRowsNewForCache(String databaseName, String tableName, String primary_key, List<String> condition, String databaseConfigId, String username, String ip) throws Exception {
        ...
        for (int i = 0; i < condition.size(); i++) {
            ...
            new Date();
            LogUtil.i("Cache删除数据行, " + DateUtils.getDateTime() + ", sql=" + sql);
    ...
    public int saveNewTableForCache(JSONArray insertArray, String databaseName, String tableName, String databaseConfigId) throws Exception {
        ...
        for (int i = 0; i < insertArray.size(); i++) {
            ...
            if (!map1.get("CHARACTER_MAXIMUM_LENGTH").equals("")) {
                sql2 = String.valueOf(sql2) + "(" + map1.get("CHARACTER_MAXIMUM_LENGTH") + ") ";
            }
    ...
    public List<Map<String, Object>> viewTableMessForCache(String dbName, String tableName, String databaseConfigId) throws Exception {
        String sql = "  select *  from  INFORMATION_SCHEMA.TABLES  WHERE TABLE_SCHEMA ='SQLUser'  AND TABLE_NAME ='" + tableName + "' ";
        DBUtilJDBC db = new DBUtilJDBC(dbName, databaseConfigId);
        List<Map<String, Object>> list = db.queryForListCommonMethod(sql);
        return list;
    }
    ...
    public List<Map<String, Object>> exportDataToSQLForCache(String databaseName, String tableName, List<String> condition, String databaseConfigId) throws Exception {
        ...
        List<Map<String, Object>> list = new ArrayList<>();
        for (int i = 0; i < condition.size(); i++) {
            List<Map<String, Object>> list2 = db.queryForListForCache(String.valueOf(sql) + condition.get(i), 0, 99999999);
    ...
    public boolean copyTableForCache(String databaseName, String tableName, String databaseConfigId) throws Exception {
        String sql4 = "create table " + tableName + "_" + DateUtils.getDateTimeString(new Date()) + "  select * from " + tableName;
        DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
        db.setupdateData(sql4);
        return true;
    }

    public boolean insertByDataListForCache(List<Map<String, Object>> dataList, String databaseName, String tableName, String databaseConfigId) throws Exception {
        DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
    ...
    public boolean updateByDataListForCache(List<Map<String, Object>> dataList, String databaseName, String tableName, String databaseConfigId, String qualification) throws Exception {
        DBUtilJDBC db = new DBUtilJDBC(databaseName, databaseConfigId);
        List<String> sqlList = new ArrayList<>();
    ...
    public boolean insertOrUpdateByDataListForCache(List<Map<String, Object>> dataList, String databaseName, String table, String databaseConfigId, String qualification) throws Exception {
        ...
        try {
            ...
            if (insertDataList.size() > 0) {
                insertByDataListForCache(insertDataList, databaseName, table, databaseConfigId);
            }
            if (updateDataList.size() > 0) {
                updateByDataListForCache(updateDataList, databaseName, table, databaseConfigId, qualification);
                return true;
            }
            return true;
        } catch (Throwable th) {
    ...
    public String createTableSQLForCache(String tableName, String databaseName, String databaseConfigId) throws Exception {
        ...
        List<Map<String, Object>> listTableColumn = getTableColumns3ForCache(databaseName, tableName, databaseConfigId);
    ...
    public boolean checkSqlIsOneTableForCache(String dbName, String sql, String databaseConfigId) {
        return false;
    }
}
