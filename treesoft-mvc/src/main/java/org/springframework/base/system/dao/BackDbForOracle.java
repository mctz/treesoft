...
/* loaded from: spring-tx-4.1.3.RELEASE.jar:org/springframework/base/system/dao/BackDbForOracle.class */
public class BackDbForOracle {
    ...
    public void readDataToFile(String databaseName, String tableName, String path, String databaseConfigId) throws Exception {
        ...
        try {
            ...
            List<Map<String, Object>> versions = db.queryForListCommonMethod(" select version  from product_component_version  where rownum<=1  ");
            if (versions.size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                Iterator<Map<String, Object>> it3 = tableColumns3ForOracle.iterator();
                while (it3.hasNext()) {
                    Map<String, Object> map32 = it3.next();
                    String column_name = (String) map32.get("COLUMN_NAME");
                    String column_comment = (String) map32.get("COLUMN_COMMENT");
                ...
                for (int yy = 0; yy < rowCount; yy += 20000) {
                    ...
                    List<Map<String, Object>> list = db.queryForListForOracleForExport(sql3, limitFrom, 20000);
                    limitFrom += 20000;
                    ...
                    while (it4.hasNext()) {
                        ...
                        String values = "";
                        Iterator<Map.Entry<String, Object>> it5 = map4.entrySet().iterator();
                        while (it5.hasNext()) {
                            Map.Entry<String, Object> entry = it5.next();
                            ...
                            if (!key.equals("RN")) {
                                ...
                                } else if (TableColumnType.get(key).equals("1") || TableColumnType.get(key).equals("varbinary") || TableColumnType.get(key).equals("blob") || TableColumnType.get(key).equals("tinyblob") || TableColumnType.get(key).equals("mediumblob") || TableColumnType.get(key).equals("longblob")) {
