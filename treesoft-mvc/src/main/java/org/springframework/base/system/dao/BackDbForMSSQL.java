...
/* loaded from: spring-tx-4.1.3.RELEASE.jar:org/springframework/base/system/dao/BackDbForMSSQL.class */
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    for (int yy = 0; yy < rowCount; yy += 20000) {
                        ...
                        List<Map<String, Object>> list = db.queryForListPageForMSSQL(sql3, 20000, limitFrom);
                        limitFrom += 20000;
                        ...
                        while (it3.hasNext()) {
                            ...
                            while (it4.hasNext()) {
                                ...
                                if (entry.getValue() == null) {
                                    ...
                                    values = String.valueOf(values) + entry.getValue() + ",";
                                } else if (TableColumnType.get(key).equals("binary") || TableColumnType.get(key).equals("varbinary") || TableColumnType.get(key).equals("blob") || TableColumnType.get(key).equals("tinyblob") || TableColumnType.get(key).equals("mediumblob") || TableColumnType.get(key).equals("longblob") || TableColumnType.get(key).equals("image")) {
