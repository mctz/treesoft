 ...
 <div id="tb4" style="padding:5px;height:auto">
      <input id="taskId" name="taskId" type="hidden" value="${taskId }"   />
                         <div>
	                       ...
	                       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" id="delButton"   onclick="deleteSqlLog()">删除</a>
...
function initData(){
	...
	dgg4=$('#dg4').datagrid({     
	method: "get",
    url: '${ctx}/system/sqlDistribute/sqlDistributeLogList/'+ taskId , 
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'id',
    ...
    columns:[[    
	  	...
	  	{field:'configName',title:'数据库配置',align: 'center',width:100 },
	  	{field:'databaseName',title:'数据库',align: 'center',width:100 },
	  	{field:'createTime',title:'运行时间',align: 'center',width:100 },
	 ...
	 $.easyui.messager.confirm("操作提示", "您确定要删除"+length+"行数据吗？", function (c) {
                if (c) {
                   ...
                   $.ajax({
                    ...
                    url:"${ctx}/system/sqlDistribute/deleteSqlDistributeLog",
