...
function initData2(){
	dgg5=$('#dg5').datagrid({     
	method: "post",
    url:"${ctx}/redis/selectNoSQLDBStatus/" + databaseConfigId ,
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'fileName',
    ...
    columns:[[  
	    {field:'TREESOFTPRIMARYKEY',checkbox:true}, 
	  	{field:'parameter',title:'参数',sortable:true,width:70 },
        {field:'value',title:'值',sortable:true,width:70},
        {field:'content',title:'参数说明',sortable:true,width:100}	  	
    ]], 
    checkOnSelect:true,
    selectOnCheck:true,
    extEditing:false,
