...
<script type="text/javascript">
  ...
  function initIndexData(){
   ...
   // var IndexTypes =[{"value":"BTREE","text":"BTREE"},{"value":"HASH","text":"HASH"}] ;
    var uniqueTypes =[{"value":"Normal","text":"Normal"},{"value":"Unique","text":"Unique"},{"value":"Bitmap","text":"Bitmap"},{"value":"ctxsys.context","text":"ctxsys.context"},{"value":"ctxsys.ctxcat","text":"ctxsys.ctxcat"}] ;    
    ...
    columns:[[    
	  	...
	  	{field:'TABLE_OWNER',title:'Owner', width:100 ,editor:{type:'text', options: { required: true }}},
        ...
        {field:'UNIQUENESS',title:'索引类型',halign:'center',width:100,editor:{type:'text', options: { required: true }},formatter: function(value,row,index){
  ...
  function initTriggerData(){
     $("#dgForTrigger").datagrid({     
        ...
        columns:[[    
	    	{field:'TREESOFTPRIMARYKEY',checkbox:true}, 		  
	    	{field:'TRIGGER_NAME',title:'TRIGGER_NAME', width:30 },
	    	{field:'TRIGGERING_EVENT',title:'TRIGGERING_EVENT',width:50   } ,
         	{field:'TRIGGER_TYPE',title:'TRIGGER_TYPE',width:50 } ,
         	{field:'ACTION_TYPE',title:'ACTION_TYPE',width:30 } ,
...
function initMessData(){
   ...
   function deleteIndex(){
	  ...
	  if(checkedItems[0]['UNIQUENESS'] == "UNIQUE"){
	       parent.$.messager.show({ title : "mess",msg: "You cannot delete primary/unique key indexes.", position: "bottomRight",icon:"warning" });
	       return ;
	  }
