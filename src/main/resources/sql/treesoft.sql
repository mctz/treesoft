...
-- ----------------------------
INSERT INTO `dms_config` VALUES ('1', '2018-10-21 19:00:30', null, 'mysql', '1', 'MySql', null, null, null, '3306', null, '127.0.0.1', null, 'test', 'jdbc:mysql://127.0.0.1:3306/test', 'root', 'cm9vdGByb290');
INSERT INTO `dms_config` VALUES ('2', '2018-10-21 22:02:18', null, 'dbutils', '0', 'MySql', null, null, null, '3306', null, '127.0.0.1', null, 'dbutils', 'jdbc:mysql://127.0.0.1:3306/dbutils', 'root', 'cm9vdGByb290');
...
INSERT INTO `dms_study` VALUES ('2', 'icon-berlin-calendar', null, '常用SQL', null, '1', null);
...
INSERT INTO `dms_study` VALUES ('8', 'icon-berlin-calendar', null, '表/索引', null, '1', null);
...
INSERT INTO `dms_study` VALUES ('16', 'icon-berlin-calendar', null, '视图', null, '1', null);
...
INSERT INTO `dms_study` VALUES ('20', 'icon-berlin-calendar', null, '函数/存储过程', null, '1', null);
...
INSERT INTO `dms_study` VALUES ('28', 'icon-berlin-project', null, 'MongoDB shell命令', null, '1', null);
INSERT INTO `dms_study` VALUES ('29', 'icon-berlin-project', null, '创建数据库use', 'use <databaseName> ', '28', null);
INSERT INTO `dms_study` VALUES ('30', 'icon-berlin-project', null, '创建数据集合db.createCollection', 'db.createCollection(<collectionName>)', '28', null);
INSERT INTO `dms_study` VALUES ('31', 'icon-berlin-project', null, '查看文档db.users.find()', 'db.users.find({})', '28', null);
INSERT INTO `dms_study` VALUES ('32', 'icon-berlin-project', null, '插入数据db.users.insert()', 'db.users.insert(<data>)', '28', null);
INSERT INTO `dms_study` VALUES ('33', 'icon-berlin-project', null, '删除数据db.users.remove()', 'db.users.remove({})', '28', null);
INSERT INTO `dms_study` VALUES ('34', 'icon-berlin-project', null, '更新数据db.users.update()', 'db.users.update(query,update)', '28', null);
INSERT INTO `dms_study` VALUES ('35', 'icon-berlin-calendar', null, 'Oracle常用查询', null, '1', null);
INSERT INTO `dms_study` VALUES ('36', 'icon-berlin-project', null, '查看连接用户信息', 'SELECT s.Osuser Os_User_Name,Decode(Sign(48 - Command),1,To_Char(Command),\r\n\'Action Code #\' || To_Char(Command)) Action,\r\np.Program Oracle_Process, Status Session_Status, s.Terminal Terminal,\r\ns.Program Program, s.Username User_Name,\r\ns.Fixed_Table_Sequence Activity_Meter, \'\' Query, 0 Memory,\r\n0 Max_Memory, 0 Cpu_Usage, s.Sid, s.Serial# Serial_Num\r\nFROM V$session s, V$process p\r\nWHERE s.Paddr = p.Addr\r\nAND s.TYPE = \'USER\'\r\nORDER BY s.Username, s.Osuser', '35', null);
INSERT INTO `dms_study` VALUES ('37', 'icon-berlin-project', null, '高速缓冲区命中率', 'select 1 - sum(decode(name, \'physical reads\', value, 0)) /\r\n(sum(decode(name, \'db block gets\', value, 0)) +\r\nsum(decode(name, \'consistent gets\', value, 0))) hit_ratio\r\nfrom v$sysstat t\r\nwhere name in (\'physical reads\', \'db block gets\', \'consistent gets\')', '35', null);
INSERT INTO `dms_study` VALUES ('38', 'icon-berlin-project', null, '查看表空间使用情况', 'SELECT Upper(F.TABLESPACE_NAME)         \"表空间名\",\r\n       D.TOT_GROOTTE_MB                 \"表空间大小(M)\",\r\n       D.TOT_GROOTTE_MB - F.TOTAL_BYTES \"已使用空间(M)\",\r\n       To_char(Round(( D.TOT_GROOTTE_MB - F.TOTAL_BYTES ) / D.TOT_GROOTTE_MB * 100, 2), \'990.99\')\r\n       || \'%\'                           \"使用比\",\r\n       F.TOTAL_BYTES                    \"空闲空间(M)\",\r\n       F.MAX_BYTES                      \"最大块(M)\"\r\nFROM   (SELECT TABLESPACE_NAME,\r\n               Round(Sum(BYTES) / ( 1024 * 1024 ), 2) TOTAL_BYTES,\r\n               Round(Max(BYTES) / ( 1024 * 1024 ), 2) MAX_BYTES\r\n        FROM   SYS.DBA_FREE_SPACE\r\n        GROUP  BY TABLESPACE_NAME) F,\r\n       (SELECT DD.TABLESPACE_NAME,\r\n               Round(Sum(DD.BYTES) / ( 1024 * 1024 ), 2) TOT_GROOTTE_MB\r\n        FROM   SYS.DBA_DATA_FILES DD\r\n        GROUP  BY DD.TABLESPACE_NAME) D\r\nWHERE  D.TABLESPACE_NAME = F.TABLESPACE_NAME\r\nORDER  BY 1', '35', null);
INSERT INTO `dms_study` VALUES ('39', 'icon-berlin-project', null, '共享池的命中率', 'select sum(pinhits)/sum(pins)*100 \"hit radio\" from v$librarycache;', '35', null);
INSERT INTO `dms_study` VALUES ('40', 'icon-berlin-project', null, '查看还没提交的事务', 'select * from v$locked_object;', '35', null);
INSERT INTO `dms_study` VALUES ('41', 'icon-berlin-project', null, '耗资源的进程', 'select s.schemaname schema_name, decode(sign(48 - command), 1,\r\nto_char(command), \'Action Code #\' || to_char(command) ) action, status\r\nsession_status, s.osuser os_user_name, s.sid, p.spid , s.serial# serial_num,\r\nnvl(s.username, \'[Oracle process]\') user_name, s.terminal terminal,\r\ns.program program, st.value criteria_value from v$sesstat st, v$session s , v$process p\r\nwhere st.sid = s.sid and st.statistic# = to_number(\'38\') and (\'ALL\' = \'ALL\'\r\nor s.status = \'ALL\') and p.addr = s.paddr order by st.value desc, p.spid asc, s.username asc, s.osuser asc', '35', null);
INSERT INTO `dms_study` VALUES ('42', 'icon-berlin-project', null, '查看锁（lock）情况', 'select /* RULE */ ls.osuser os_user_name, ls.username user_name,\r\ndecode(ls.type, \'RW\', \'Row wait enqueue lock\', \'TM\', \'DML enqueue lock\', \'TX\',\r\n\'Transaction enqueue lock\', \'UL\', \'User supplied lock\') lock_type,\r\no.object_name object, decode(ls.lmode, 1, null, 2, \'Row Share\', 3,\r\n\'Row Exclusive\', 4, \'Share\', 5, \'Share Row Exclusive\', 6, \'Exclusive\', null)\r\nlock_mode, o.owner, ls.sid, ls.serial# serial_num, ls.id1, ls.id2\r\nfrom sys.dba_objects o, ( select s.osuser, s.username, l.type,\r\nl.lmode, s.sid, s.serial#, l.id1, l.id2 from v$session s,\r\nv$lock l where s.sid = l.sid ) ls where o.object_id = ls.id1 and o.owner\r\n<> \'SYS\' order by o.owner, o.object_name', '35', null);
INSERT INTO `dms_study` VALUES ('43', 'icon-berlin-project', null, '查看等待（wait）情况', 'SELECT v$waitstat.class, v$waitstat.count count, SUM(v$sysstat.value) sum_value\r\nFROM v$waitstat, v$sysstat WHERE v$sysstat.name IN (\'db block gets\',\r\n\'consistent gets\') group by v$waitstat.class, v$waitstat.count', '35', null);
INSERT INTO `dms_study` VALUES ('44', 'icon-berlin-project', null, '查看sga情况', 'SELECT NAME, BYTES FROM SYS.V_$SGASTAT ORDER BY NAME ASC', '35', null);
INSERT INTO `dms_study` VALUES ('45', 'icon-berlin-project', null, '查看表空间的碎片程度', 'select tablespace_name,count(tablespace_name) from dba_free_space group by tablespace_name\r\nhaving count(tablespace_name)>10;\r\nalter tablespace name coalesce;\r\nalter table name deallocate unused;\r\ncreate or replace view ts_blocks_v as\r\nselect tablespace_name,block_id,bytes,blocks,\'free space\' segment_name from dba_free_space\r\nunion all\r\nselect tablespace_name,block_id,bytes,blocks,segment_name from dba_extents;\r\nselect * from ts_blocks_v;\r\nselect tablespace_name,sum(bytes),max(bytes),count(block_id) from dba_free_space\r\ngroup by tablespace_name;', '35', null);
...
-- ----------------------------
INSERT INTO `dms_users` VALUES ('1', '2015-08-08', 'admin', '7c4ad84514ff2c2c664f7b1255f640e4', '0', '管理员', '0', '475b8556f5f6ab0a8a7fcc86e105aab5', '版权所有，请尊重并支持国产软件', 'synchronize,monitor,backdatabase,person,config,json,task', '1,2,3', '2099-12-30 23:59:59');
INSERT INTO `dms_users` VALUES ('2', '2015-08-08', 'treesoft', '0aeb0993855641272bce26eed6017aff', '0', '管理员', '0', 'cebc228fc46e893b35a9c032ce7e800f', '版权所有，请尊重并支持国产软件', 'synchronize,monitor,backdatabase,person,config,json,task', '1,2,3', '2099-12-30 23:59:59');
